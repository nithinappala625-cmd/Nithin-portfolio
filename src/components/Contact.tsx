...
export default function Contact({ heroData }: { heroData: HeroData }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                I&apos;m looking for new opportunities. Whether you have a
                question or just want to say hi, feel free to reach out!
              </p>

              <div className="space-y-5">
                <a
                  href="mailto:nithinpatel2025@gmail.com"
                  className="flex items-center text-slate-700 hover:text-blue-600 transition-colors group"
                >
                  ...
                  <span className="font-medium">nithinpatel2025@gmail.com</span>
                </a>

                <a
                  href="https://www.linkedin.com/in/nithindata31/"
                  target="_blank"
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-slate-900 resize-none"
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 rounded-xl font-semibold transition-colors disabled:opacity-50 shadow-md"
                >
